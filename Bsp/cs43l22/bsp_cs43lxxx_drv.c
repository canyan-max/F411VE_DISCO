...
static cs43lxxx_status_t cs43lxxx_init(cs43xxx_drv_t *p_drv, uint8_t volume)
{
    ...
    reg_value = 0x00;
    ret = CS43LXXX_WRITE_REG(p_drv, CS43L22_REG_PASSTHR_A_SELECT, &reg_value, 1);
    if(CS43LXXX_STATUS_OK != ret)
    {
        return ret;
    }
    reg_value = 0x00;
    ret = CS43LXXX_WRITE_REG(p_drv, CS43L22_REG_PASSTHR_B_SELECT, &reg_value, 1);
    if(CS43LXXX_STATUS_OK != ret)
    {
        return ret;
    }
    ...
    reg_value = 0x00;
    ret = CS43LXXX_WRITE_REG(p_drv, CS43L22_REG_PASSTHR_GANG_CTL, &reg_value, 1);
    if(CS43LXXX_STATUS_OK != ret)
    {
        return ret;
    }
    ...
    reg_value = 0x05U;
    ret = CS43LXXX_WRITE_REG(p_drv, CS43L22_REG_CHARGE_PUMP_FREQ, &reg_value, 1);
    if(CS43LXXX_STATUS_OK != ret)
    {
        return ret;
    }
